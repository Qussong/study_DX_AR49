...
void CLevelMgr::Init()
{
	...
	CGameObject* pObj = nullptr;
	{
		...
		Ptr<CTexture> pTex = CAssetMgr::GetInst()->Load<CTexture>(L"PlayerTexture", L"texture\\player2.png");
		...
		//	, Vec2(120.f, 130.f), Vec2(0.f, 0.f), Vec2(300.f, 300.f), 3, 10.f);
		...
		pObj->Animator2D()->Create(L"ani_bluebird_jump", pAltasTex2
			, Vec2(0.f, 0.f), Vec2(32.f, 32.f), Vec2(0.f, 0.f), Vec2(40.f, 40.f)/*Vec2(32.f, 32.f)*/, 4, 8.f);
